...
public class A4BillTest {
    ...
    public void createA4PDFBill1() {
        Bill bill = SampleData.getExample1();
        byte[] pdf = QRBill.generate(bill, QRBill.BillFormat.A4PortraitSheet, QRBill.GraphicsFormat.PDF);
    ...
    public void createA4PDFBill2() {
        Bill bill = SampleData.getExample2();
        byte[] svg = QRBill.generate(bill, QRBill.BillFormat.A4PortraitSheet, QRBill.GraphicsFormat.PDF);
